...
label_0 = Label(root, text="Receive Truck and Document(s)", width=30,
                background="tomato", font=("bold", 18)).place(x=70, y=25)

label_1 = Label(root, text="Registration:", width=30,
                background="tomato", font=("bold", 13)).place(x=40, y=90)
entry_1 = Entry(root, textvar=Truck, background="yellow",
                font=("bold", 12)).place(x=230, y=90)

label_2 = Label(root, text="Delivery Note Number(s):", width=30,
                background="tomato", font=("bold", 13)).place(x=40, y=140)
