...
def update_closing():
    ...
    with sqlite3.connect('Reflex Footwear.sql3') as conn:
        ...
        cursor.execute('INSERT INTO ProductionBreakdown (Factory,Date,Line,Order2,Style,Closing,Reason) VALUES(?,?,?,?,?,?,?)', ["Reflex", timestampStr, line, code, desc, balance, reason])
...
label_0 = Label(root, text="Closing Score", background="lightblue1", width=20, font=("Arial", 20, "bold")).place(x=80, y=23)
...
# Inserting buttons
submit1 = Button(root, text='Submit', style='S.TButton', width=11, command=update_closing).place(x=20, y=320)
