...
def Balance():
    ...
    if order is not None:
        with sqlite3.connect('Reflex Footwear.sql3') as conn4:
            ...
            cursor4.execute('SELECT Factory,Planned,Order2,Style,Deldate,Orderqty,Cutting,Assembly,Closing,Finishing,Despatch,ToShip,Shipped FROM Production_Balances WHERE Order2=?', (order,))
            ...
            item_0_in_result7 = [_[6] for _ in results] # Assembly
            item_0_in_result8 = [_[7] for _ in results] # Closing
            item_0_in_result9 = [_[8] for _ in results] # Finishing
            item_0_in_result10 = [_[9] for _ in results] # Despatch
            ...
            Label(root4, text="Assembly:", width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=500, y=200)
            Label(root4, text=item_0_in_result7, width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=710, y=200)

            Label(root4, text="Closing:", width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=500, y=250)
            Label(root4, text=item_0_in_result8, width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=710, y=250)

            Label(root4, text="Finishing:", width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=500, y=300)
            Label(root4, text=item_0_in_result9, width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=710, y=300)

            Label(root4, text="Despatch:", width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=500, y=350)
            Label(root4, text=item_0_in_result10, width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=710, y=350)

            Label(root4, text="Balance To Ship:", width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=500, y=400)
            Label(root4, text=item_0_in_result11, width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=710, y=400)

            Label(root4, text="Shipped:", width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=500, y=450)
            Label(root4, text=item_0_in_result12, width=20, background="skyblue2", foreground="", font=("Arial, bold", 14)).place(x=710, y=450)
...
def Cutting():
    ...
    def CutUpdate():
        ...
        with sqlite3.connect('Reflex Footwear.sql3') as conn:
            cursor3 = conn.cursor()
            cursor3.execute('UPDATE Production SET Cutting=Cutting-? WHERE Order2=?', [balance, code,])
            cursor3.execute('UPDATE Production SET Assembly=Assembly+? WHERE Order2=?', [balance, code,])
            cursor3.execute('UPDATE Production_Balances SET Cutting=Cutting-? WHERE Order2=?', [balance, code, ])
    ...
    submit_btn = Button(root3, text='Submit', width=11, style='S.TButton', command=CutUpdate)
...
def Assembly():
    ...
    def AssemblyUpdate():
        ...
        with sqlite3.connect('Reflex Footwear.sql3') as conn:
            ...
            cursor3.execute('UPDATE Production_Balances SET Assembly=Assembly-? WHERE Order2=?', [balance, code, ])
