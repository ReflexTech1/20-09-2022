...
def save_db(dbpath=r'C:\RSoft\Current\Reflex Footwear.sql3', excel_path=None, csv_path=None, extension="*.sqlite", csvs=True, excels=True):
    ...
    excel_path = os.path.join(
        main_path, "Fortnightly Scores(A).xlsx") if excel_path == None else excel_path
...
# SELECT Table
    if (excels == True and csvs == True):
        ...
        for table_name in tables:
            ...
            table = pd.read_sql_query("SELECT Date,Order2,Line,Style,Clicking,Closing,Despatch,Warehouse,Shipped,Reason FROM ProdBreak_Archive WHERE Date BETWEEN '12-16-2022' AND '12-29-2022';",  db)
