...
def reflex_prod():
    ...
    with sqlite3.connect('Reflex Footwear.sql3') as conn:
        ...
        mycursor.execute(
            "SELECT Factory,Date,Order2,Clicking,Closing,Despatch,Shipped FROM ProductionBreakdown")
        for row in mycursor:
            tree.insert('', 'end', values=row[1:7])
...
tree = ttk.Treeview(frame, columns=(1, 2, 3, 4, 5, 6),
