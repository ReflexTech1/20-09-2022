...
root.title("New Order Pre-Boys Synthetic")
...
def order_pb():
    ...
    with sqlite3.connect('Reflex Footwear.sql3') as conn:
        ...
        cursor.execute(r'INSERT INTO Production (Factory,Planned,Order2,Style,DelDate,Orderqty,Clicking,Closing,Finishing,Despatch,ToShip,Shipped) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)', [
                       "Reflex", timestampStr, code, "PRE BOYS SYNTHETIC", delivery, qty, qty, "0", "0", "0", qty, "0",])
        ...
        cursor.execute(r'INSERT INTO Planning (Factory,DatePlanned,OrderNo,Style,Pairs,Delivery,Size8,Size9,Size10,Size11,Size12,Size13,Size1) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)', [
                       "Reflex", timestampStr, code, "PRE BOYS SYNTHETIC", qty, delivery, size8, size9, size10, size11, size12, size13, size1])
...
submit1 = Button(root, text='Submit', style='S.TButton',
                 width=11, command=order_pb).place(x=20, y=510)
