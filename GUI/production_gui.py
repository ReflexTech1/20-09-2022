...
l1 = Label(root, text="Production Interface", width=120, anchor=CENTER, font=["Bodoni MT", 30, "bold"], background="grey80", relief="raised").pack(side='top', ipady=10)
...
btn7 = Button(root, text="Archive", style='R.TButton', command=tkinter8).pack(side='left')
