    ...
    if qty == sum([size2+size3+size4+size5+size6+size7b+size8b]):
        with sqlite3.connect('Reflex Footwear.sql3') as conn:
            ...
            cursor.execute(r'INSERT INTO Planning (Factory,DatePlanned,OrderNo,Style,Pairs,Delivery,Size2,Size3,Size4,Size5,Size6,Size7b,Size8b) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)', [
                           "Reflex", timestampStr, code, "GIRLS SYNTHETIC", qty, delivery, size2, size3, size4, size5, size6, size7b, size8b])
            ...
            cursor.execute(r'INSERT INTO TBARequired (Factory,InputDate,OrderNo,Style,Pairs,DelDate,Upper,Stiffener,Insole,Sock,Buckles,Foil,Gusset,Rivets,PBA887,IA80,Cartons,TBASize2,TBASize3,TBASize4,TBASize5,TBASize6,TBASize7b,TBASize8b)'
                           ...
                           ["Reflex", timestampStr, code, "GIRLS SYNTHETIC", qty, delivery, qty, qty, qty, qty, qty, qty, qty, qty, qty, qty, qty, size2, size3, size4, size5, size6, size7b, size8b])
            # Upper Material
        ...
        with sqlite3.connect('Log Sheets.sql3') as conn2:
            ...
            cursor2.execute(r'INSERT INTO [%s] (Barcode,OrderNo,Style,Delivery,Size2,Size3,Size4,Size5,Size6,Size7b,Size8b,Qty,Ticket) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)' %code, [ barcode, code, "GIRLS SYNTHETIC", delivery, size2, size3, size4, size5, size6, size7b, size8b, qty, 158])
