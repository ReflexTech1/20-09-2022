...
def order_pbi():
    ...
    with sqlite3.connect('Log Sheets.sql3') as conn2:
        ...
        cursor2.execute(r'INSERT INTO [%s] (Barcode,OrderNo,Style,Delivery,Size8,Size9,Size10,Size11,Size12,Size13,Size1,Qty,Ticket) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)' %code, [ barcode, code, "PRE BOYS IDLER", size8, size9, size10, size11, size12, size13, size1, qty, 158])
