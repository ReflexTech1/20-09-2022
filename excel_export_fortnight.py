...
def export_to_excel():
    ...
    data = r"SELECT Date,Line,Order2,Style,Despatch,Reason FROM ProductionBreakdown WHERE Date BETWEEN ? AND ? UNION SELECT Date,Line,Order2,Style,Despatch,Reason FROM ProdBreak_Archive WHERE Date BETWEEN ? AND ?"
