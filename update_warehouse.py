...
def update_warehouse():
    ...
    with sqlite3.connect('Reflex Footwear.sql3') as conn:
        ...
        cursor.execute('INSERT INTO ProductionBreakdown (Factory,Date,Line,Order2,Style,Warehouse,Reason) VALUES(?,?,?,?,?,?,?)', ["Reflex", timestampStr, line, code, desc, balance, reason])
...
submit1 = Button(root, text='Submit', style='S.TButton',
                 width=11, command=update_warehouse).place(x=20, y=320)
