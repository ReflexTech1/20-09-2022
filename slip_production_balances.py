...
l1 = Label(root, text="Slipper Production Balances", width=120, anchor=CENTER, font=["Bodoni MT", 30, "bold"], background="grey80", relief="raised").pack(side='top', ipady=10)
...
def tkinter1():
    ret = os.system(r'python excel_export_slip_balances.py')
    if ret:
        exit()
