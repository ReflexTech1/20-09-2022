...
def save_db(dbpath=r'C:\Production Software\Reflex Footwear.sql3', excel_path=None, csv_path=None, extension="*.sqlite", csvs=True, excels=True):
    ...
    internal_folder = "Size Range(" + timestampStr + ")"
    main_path = os.path.join(external_folder, internal_folder)
    create_dir(main_path)

    excel_path = os.path.join(
        main_path, "Size Range.xlsx") if excel_path == None else excel_path
...
# SELECT Table
    if (excels == True and csvs == True):
        ...
        for table_name in tables:
            ...
            table = pd.read_sql_query("SELECT OrderNo,Style,Pairs,Delivery,Size8,Size9,Size10,Size11,Size12,Size13,Size1,Size2,Size3,Size4,Size5,Size6,Size7,Size8b,Size9b,Size10b from Planning", db)
